...
public class App {
	...
	public static void main(String[] args) {
		...
		TransactionService.getInstance().makeTranasction(accouList.get(0), accouList.get(1), 3000);
		
		//Clark DEbit 3000 from account
		TransactionService.getInstance().withDrawcash(TransferType.DEBIT,accouList.get(0) , 3000);
		
		System.out.println("clark Balance:"+accouList.get(0).getAccountBalance()); 
	}
}
